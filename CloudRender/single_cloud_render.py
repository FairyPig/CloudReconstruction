...
# rotate_angle is from (0, 3.14*2)
def LoadandSetCloud(cloud_path, cloud_name, rotate_angle):
    ...
    #AFAN 2019.4.13 rotate the model for render
    bpy.ops.object.editmode_toggle()
    bpy.ops.transform.rotate(value=rotate_angle, axis=(0,0,1),constraint_axis=(False,False,True),constraint_orientation='GLOBAL', mirror=False, proportional='DISABLED',proportional_edit_falloff='SMOOTH',proportional_size=1,release_confirm=True)
    bpy.ops.object.editmode_toggle()
...
rotation_angle = float(sys.argv[-7])
...
LoadandSetCloud(shape_file, obj_name, rotation_angle)
